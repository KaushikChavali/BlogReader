package com.example.admin.blogreader;
    ...
    public void handleBlogResponse() {
        ...
        if(mBlogData == null){
            ...
            try {
                ...
                String[] keys = {KEY_TITLE, KEY_AUTHOR, KEY_THUMBNAIL};
                int[] ids = {R.id.title, R.id.author, R.id.thumbnail};

                SimpleAdapter adapter = new SimpleAdapter(this, blogPosts, R.layout.custom_list_view, keys, ids);
